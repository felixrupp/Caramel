	...
	<table id="pageManagementTable">
		...
		<?php foreach($pages as $naventry) { ?>
			<tr>
				...
				<td><a href="?q=moveup&id=<?php echo $naventry["id"] ?>" class="moveup"><img src="<?php echo TEMPLATEDIR; ?>/Backend/images/up.png" width=" 15px" title="Move Up" alt="Move Up"></a></td>
				<td><a href="?q=movedown&id=<?php echo $naventry["id"] ?>" class="movedown"><img src="<?php echo TEMPLATEDIR; ?>/Backend/images/down.png" width=" 15px" title="Move Down" alt="Move Down"></a></td>
			...
			<?php if(isset($naventry["subpages"]) && count($naventry["subpages"]>0)) {?>
				<?php foreach($naventry["subpages"] as $subentry) {?>
					<tr>
						...
						<td><a href="?q=moveup&id=<?php echo $subentry["id"] ?>" class="moveup"><img src="<?php echo TEMPLATEDIR; ?>/Backend/images/up.png" width=" 15px" title="Move Up" alt="Move Up"></a></td>
						<td><a href="?q=movedown&id=<?php echo $subentry["id"] ?>" class="movedown"><img src="<?php echo TEMPLATEDIR; ?>/Backend/images/down.png" width=" 15px" title="Move Down" alt="Move Down"></a></td>
